...
public class MissingMemberCaller {
    MethodAccessChange methodAccessChange;

    void callMethodWithChangedReturnType() {
        methodAccessChange.voidToNonVoidReturnType("");
    }

    void accessFieldWithChangedType() {
        new FieldAccessChange().typeChangedField = "";
    }
}
